...
unsigned char my_ip[IP_ADDR_LEN]={192,168,2,2};
// unsigned char my_ip[IP_ADDR_LEN]={141,213,9,135};
// unsigned char my_mac[ETH_ADDR_LEN]={0xEE,0xC5,0x37,0x3F,0xA1,0x30};  // actel
unsigned char my_mac[ETH_ADDR_LEN]={0xB8,0x27,0xEB,0xA4,0xA1,0xF0};  // pi
// unsigned char my_mac[ETH_ADDR_LEN]={0x00,0x24,0x81,0xc4,0xdf,0xae};
...
static const unsigned char g_client_ip[IP_ADDR_LEN] = { 192, 168, 2, 2 };
